...
export default function StaffResolvedTickets() {
      ...
      {tickets.length === 0 ? (
        <div className="flex h-full flex-col bg-white">
          <div className="flex  h-full flex-col items-center justify-center gap-2 border-y border-gray-200 bg-gray-50">
            ...
            <p className="max-w-[480px] pt-2 text-center text-sm text-[#475467]">
              There are currently no tickets to display. Once a ticket is
              resolved, it will appear here for your review.
            </p>
          </div>
        </div>
      ) : (
